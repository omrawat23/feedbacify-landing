  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 py-16 bg-white text-center">
      ...
      <div className="w-full max-w-3xl mx-auto">
        <div className="inline-flex items-center px-3 py-1 mb-8 text-xs sm:text-sm font-medium text-gray-600 bg-gray-100 rounded-full">
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 justify-center">
          <Link href={isSignedIn ? '/dashboard' : 'https://prime-moray-67.accounts.dev/sign-in?redirect_url=https%3A%2F%2Ffeedbacify-landing.vercel.app%2F'}>
            <Button className="w-full sm:w-auto px-8 py-3 text-base font-semibold text-white bg-black rounded-md transition duration-300">
              Get Started
            </Button>
          </Link>
          <Button variant="outline" className="w-full sm:w-auto px-8 py-3 text-base font-semibold text-gray-700 border-gray-300 hover:bg-gray-100 rounded-md transition duration-300">
            Learn more →
          </Button>
        </div>
      </div>
      ...
      <div className="mt-16 w-full max-w-4xl mx-auto">
        ...
        {/* Second Section */}
        <div className="mt-4 bg-gray-800 rounded-lg shadow-lg overflow-hidden w-full max-w-[800px] mx-auto">
